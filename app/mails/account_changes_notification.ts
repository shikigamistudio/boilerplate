...
export default class AccountChangesNotification extends BaseMail {
  from = 'no-reply@shikigamistudio.com'
  subject = 'ShikigamiStudio Account Changes'
  ...
  prepare() {
    ...
    this.message.htmlView('emails/account_changes_html', {
